            ...
            <?php } ?>
                ...
                <li class="btn btn-paging notblank next">
                    ...
                    <?php previous_posts_link(
                          __('Newer posts', "relational") . " &raquo;"); ?></li>
                <?php } ?>
        ...
        <section id="sidebar">
            ...
            <?php dynamic_sidebar( 'footer-sidebar' ); ?><br>
                ...
                <div class="meta-default">
                    ...
                    value="<?php esc_attr_e( 'Search', 'relational' ); ?>">
